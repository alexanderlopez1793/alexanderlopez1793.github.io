...
## Control Parameters
```{r}
df = read.table("/Users/alexanderlopez/Documents/SMU/Classes/MSDS_6306_Doing_Data_Science/Unit_1/Unit 1/yob2016.txt",stringsAsFactors = FALSE,header = FALSE,sep = ";")
